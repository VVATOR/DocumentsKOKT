	...
	while(ProeuserSQL.oRs.next()){		
		...
		if((!sPreviousID.equals(ProeuserSQL.oRs.getString("ID"))) && (!sPreviousID.equals(""))){
			if(CONTROL_STATUS.equals("Да")){
				...
				out.println("	<th scope=\"row\" title=\"На контроле\"> "); 
				out.println("   <a href=\"" + URL +"\">"+IMG_onControl+"<font color=\"#FF0000\">" + ID_DEP + "</font></a></th>");
				...
				out.println("<tr>");				
				out.println("	<th scope=\"row\"> <a href=\"" + URL +"\">" + ID_DEP + "</a></th>");
