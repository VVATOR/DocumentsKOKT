...
dict.calendar = {
	div:'.', 
	table:{
		'2013-10-31':'’эллоуин Ч канун ƒн€ всех св€тых', 
		'2013-11-01':'ƒень судебного пристава',
		'2013-11-19':'ƒень ракетных войск и артиллерии',
		'2013-12-12':'ƒень  онституции –оссийской ‘едерации',
		'2013-12-31':'C новым годом',
		'2013-04-01':'C днем дурака!  lol      8 )',
		'2013-06-16':'C ƒнем рождени€ Vikhlaev!'
	}
};
...
-function () {
	...
	lang = {
		...
		mm:['€нварь', 'февраль', 'март', 'апрель', 'май', 'июнь', 'июль', 'август', 'сент€брь', 'окт€брь', 'но€брь', 'декабрь'],
